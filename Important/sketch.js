...
var bombI, soldierI,lootI, bulletI, bullet
var database, name, loot, bombs, password, dob, mobileno, soldier,playerCount
...
ground=createSprite(width/3.5,height/1.315,500,5)
ground.visible=false

roof=createSprite(width/3.5,height/3,500,5)
roof.visible=false
